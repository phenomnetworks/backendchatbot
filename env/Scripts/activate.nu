...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Mattia\Desktop\chatbot-deployment-main\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Mattia\Desktop\chatbot-deployment-main\env\Scripts\deactivate.nu'
